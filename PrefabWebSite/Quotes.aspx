...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <dx:ASPxGridView ID="ASPxGridViewQuotes" runat="server" AutoGenerateColumns="False" DataSourceID="dsQuotes" EnableTheming="True" KeyFieldName="Quote_ID" Theme="Glass">
        ...
        <Columns>
            ...
            <dx:GridViewDataDateColumn Caption="Sendt" FieldName="Sent_Date" ShowInCustomizationForm="True" VisibleIndex="17" SortIndex="0" SortOrder="Descending">
                <PropertiesDateEdit DisplayFormatString="dd. MMM yy">
                </PropertiesDateEdit>
                <SettingsHeaderFilter Mode="DateRangeCalendar">
                </SettingsHeaderFilter>
